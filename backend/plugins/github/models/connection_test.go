		...
		},
		{
			...
			fields: fields{
				GithubConn: GithubConn{
					GithubAccessToken: GithubAccessToken{
						AccessToken: api.AccessToken{
							Token: "ghp_this_is_a_fake_token_for_test_purposes_only",
						},
					},
				},
			},
			want: GithubConnection{
				GithubConn: GithubConn{
					GithubAccessToken: GithubAccessToken{
						AccessToken: api.AccessToken{
							Token: "ghp_this_is_a_f********************purposes_only",
						},
					},
				},
			},
		},
		{
			...
			fields: fields{
				GithubConn: GithubConn{
					GithubAccessToken: GithubAccessToken{
						AccessToken: api.AccessToken{
							Token: "ghp_fake_token_1_for_test_purposes_only,ghp_fake_token_2_for_test_purposes_only",
						},
					},
				},
			},
			want: GithubConnection{
				GithubConn: GithubConn{
					GithubAccessToken: GithubAccessToken{
						AccessToken: api.AccessToken{
							Token: "ghp_fake_toke********************purposes_only,ghp_fake_toke********************purposes_only",
						},
					},
				},
			},
		...
		},
		{
			...
			fields: fields{
				GithubConn: GithubConn{
					GithubAccessToken: GithubAccessToken{
						AccessToken: api.AccessToken{
							Token: "github_pat_this_is_a_fake_token_for_test_purposes_only_which_is_very_long_indeed_so_it_should_pass,",
						},
					},
				},
			},
			want: GithubConnection{
				GithubConn: GithubConn{
					GithubAccessToken: GithubAccessToken{
						AccessToken: api.AccessToken{
							Token: "github_pat_this_is_a_f******************************************************************T4U1",
						},
					},
				},
			},
