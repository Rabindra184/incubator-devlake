...
var CollectCasesMeta = plugin.SubTaskMeta{
	Name:             "collectCases",
	EntryPoint:       CollectCases,
	EnabledByDefault: true,
	Description:      "Collect cases data from Testrail api",
...
func CollectCases(taskCtx plugin.SubTaskContext) errors.Error {
	...
	collector, err := helper.NewApiCollector(helper.ApiCollectorArgs{
		...
		PageSize:    250,
		Incremental: false,
		UrlTemplate: "index.php?/api/v2/get_cases/{{ .Params.ProjectId }}",
